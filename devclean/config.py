...
class CruftPattern:
    ...
    category: str
    description: str
    check_installed: Optional[str] = None  # Command to check if tool is installed
...
CRUFT_PATTERNS: List[CruftPattern] = [
    ...
    CruftPattern(
        ...
        "python", "Pre-commit hook environments",
    ...
    CruftPattern(
        "{home}/.cache/torch",
        "ml", "PyTorch downloaded models",
        check_installed=None,  # No single binary
    ),
    CruftPattern(
        "{home}/.cache/huggingface",
        "ml", "HuggingFace models and datasets",
        check_installed=None,
    ),
    CruftPattern(
        "{home}/.cache/whisper",
        "ml", "OpenAI Whisper models",
        check_installed=None,
    ),
    ...
    CruftPattern(
        "{home}/.docker",
        "docker", "Docker config and buildx cache",
        check_installed="docker --version",
    ),
    ...
    CruftPattern(
        ...
        "testing", "Playwright browser binaries",
        check_installed=None,
    ),
    CruftPattern(
        "{home}/.cache/ms-playwright",
        "testing", "Playwright browsers (cache)",
        check_installed=None,
    ),
    CruftPattern(
        "{home}/.cache/selenium",
        "testing", "Selenium webdriver cache",
        check_installed=None,
    ),
    ...
    CruftPattern(
        ...
        "xcode", "Xcode app archives",
        check_installed="xcodebuild -version",
        safe=False,  # User might want these
    ),
    CruftPattern(
        "{home}/Library/Developer/Xcode/iOS DeviceSupport",
        "xcode", "iOS device support files",
        check_installed="xcodebuild -version",
    ),
    CruftPattern(
        "{home}/Library/Developer/CoreSimulator/Caches",
        "xcode", "iOS Simulator caches",
        check_installed="xcodebuild -version",
    ),
    ...
    CruftPattern(
        "{home}/.cache/act",
        "ci", "act (local GitHub Actions) cache",
    ...
    CruftPattern(
        "{home}/.cargo/registry",
        "rust", "Cargo package registry cache",
